...
public class KafkaConfig {
	...
	private String transactionIdprfix ;
	...
	public Map<String, Object> producerConfigs() {
		...
		props.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, transactionIdprfix);
		return props;
	}
	...
	@Bean
	KafkaTemplate<String, Object> kafkaTemplate(ProducerFactory<String, Object> producerFacttory) {
		return new KafkaTemplate<String, Object>(producerFacttory);
	}
	
	@Bean
	KafkaTransactionManager<String, Object> kafkaTransactionManager(ProducerFactory<String, Object> producerFacttory){
		return new KafkaTransactionManager<>(producerFacttory);
	}
